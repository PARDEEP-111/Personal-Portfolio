...
const TechStack = () => {
  ...
  return (
    <div id="techstack" className="w-full scroll-mt-90 flex flex-col items-center bg-[#161513] ">
      
        <h1 className="text-2xl lg:text-4xl font-bold  mb-6 text-white">Tech Stack</h1>
