function Connect() {
  ...
  return (
    <div id="connect" className="w-full bg-[#161513] scroll-mt-20 pb-13 px-4 flex flex-col items-center">
      <h2 className="text-2xl lg:text-4xl  font-bold mb-5 ">Let's Connect</h2>
