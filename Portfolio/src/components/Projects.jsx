...
function Projects() {
  ...
  return (
    <div  id="projects" className="bg-[#161513]  scroll-mt-80  w-full text-white p-2 flex flex-col items-center">
      <h1 className="text-2xl lg:text-4xl font-bold p-5">Projects</h1>
